...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, num_buckets, color, invdepths, radii, view_first, view_alpha, geomBuffer, binningBuffer, imgBuffer, sampleBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, view_first, view_alpha, invdepths

    @staticmethod
    def backward(ctx, grad_out_color, _, xx, xx1, grad_out_depth):
